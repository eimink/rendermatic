...
```sh
apk add nano git cmake clang clang-dev make gcc g++ libc-dev linux-headers directfb directfb-dev
```
...
As the Wayland/GLFW on nixos is working, might as well test on alpine...
